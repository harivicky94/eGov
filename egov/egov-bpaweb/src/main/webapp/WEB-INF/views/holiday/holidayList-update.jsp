			...
			<div class="panel panel-primary" data-collapsed="0">
				<div class="form-group">
					...
					<div class="col-sm-3 add-margin">
						<form:input path="holidayDate" class="form-control datepicker"
							id="holidayDate" data-inputmask="'mask': 'd/m/y'" />
						<form:errors path="holidayDate" cssClass="add-margin error-msg" />
					</div>
					<label class="col-sm-3 control-label text-right"><spring:message
							code="lbl.holidayType" /></label>
					<div class="col-sm-3 add-margin">
						<form:select path="holidayType" data-first-option="false"
				...
				<div class="form-group">
					...
					<div class="col-sm-3 add-margin">
						<form:input class="form-control patternvalidation" maxlength="50"
							id="year" path="year" disabled="true" />
