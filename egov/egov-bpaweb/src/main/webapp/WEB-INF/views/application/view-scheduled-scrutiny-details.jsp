...
<c:forEach items="${bpaApplication.slotApplications}" var="appoimnt"
		   varStatus="counter">
	<div class="panel-heading custom_form_panel_heading">
		<div class="panel-title">
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${appoimnt.slotDetail.slot.appointmentDate}" default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.appmnt.time" />
		</div>
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${appoimnt.slotDetail.appointmentTime}" default="N/A"></c:out>
		</div>
	</div>
</c:forEach>
