...
<div class="panel-body">
	...
	<div class="form-group">
		...
		<div class="col-sm-3 add-margin">
			...
			<form:errors path="owner.user.aadhaarNumber" data-server-error="owner.user.aadhaarNumber"
						 cssClass="add-margin error-msg" />
		</div>
	</div>
</div>