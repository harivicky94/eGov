		...
		<div class="col-md-12">
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body">
					...
					<%--<div class="form-group">
						<label class="col-sm-2 control-label text-right"> By Days
						</label>
						<div class="col-sm-3 add-margin">
...
<script src="<cdn:url value='/resources/js/app/regular-slotdetails-report.js?rnd=${app_release_no}'/> "></script>
