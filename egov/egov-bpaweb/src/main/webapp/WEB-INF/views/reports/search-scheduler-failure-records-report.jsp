...
<form:form role="form" action=""
	...
	id="recordsSchedulingFailedReport"
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:select path="zoneId" data-first-option="false" id="zone"
								...
								<form:options items="${employeeMappedZone}" itemValue="id"
									itemLabel="name" />
							</form:select>
...
<script
	src="<cdn:url value='/resources/js/app/failedbpaapplications-search.js?rnd=${app_release_no}'/> "></script>
