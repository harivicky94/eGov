...
<div class="panel-body">
    ...
    <div id="showhide" class="hide">
        <div class="form-group">
            ...
            <div class="col-sm-3 add-margin">
                <form:input type="text" cssClass="form-control addremoverequired"
                            path="organizationName" autocomplete="off" maxlength="128" id="organizationName"/>
            ...
            <div class="col-sm-3 add-margin">
                <form:input type="text" cssClass="form-control patternvalidation addremoverequired"
                            path="organizationMobNo" autocomplete="off" data-pattern="number" maxlength="11"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3 add-margin">
                <form:input type="text" cssClass="form-control addremoverequired"
                            path="contactPerson" maxlength="50" autocomplete="off" id="contactPerson"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3 add-margin">
            <form:input path="name"
                        ...
                        data-pattern="alphanumeric" maxlength="100" autocomplete="off" required="required"/>
    ...
    <c:if test="${isEmployee}">
        <div class="form-group">
            ...
            <div class="col-sm-3 add-margin">
                <form:input type="text" cssClass="form-control" autocomplete="nope" path="code" id="code"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3 add-margin">
            <form:input type="text" cssClass="form-control patternvalidation mobileno-field"
                        ...
                        id="mobileNumber1" autocomplete="false" required="required"/><span class=""></span>
        ...
        <div class="col-sm-3 add-margin">
            <form:input type="text" cssClass="form-control patternvalidation"
                        ...
                        id="emailId1" maxlength="128" autocomplete="false" required="required"/><span class=""></span>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3 add-margin">
            <form:input type="text" cssClass="form-control"
                        path="licenceNumber" maxlength="64" autocomplete="off" id="licenceNumber" required="required"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3 add-margin">
            <form:input type="text" cssClass="form-control patternvalidation" path="pan"
                        data-pattern="alphanumeric" id="panNumber" autocomplete="off" minlength="10" maxlength="10"/>
