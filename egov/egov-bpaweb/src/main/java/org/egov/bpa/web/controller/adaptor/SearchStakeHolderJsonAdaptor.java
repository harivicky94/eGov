...
public class SearchStakeHolderJsonAdaptor implements JsonSerializer<SearchStakeHolderForm> {
    ...
    public JsonElement serialize(final SearchStakeHolderForm stakeHolderForm, final Type type,
        ...
        if (stakeHolderForm != null) {
            jsonObject.addProperty("applicantName", org.apache.commons.lang.StringUtils.defaultString(stakeHolderForm.getApplicantName()));
            jsonObject.addProperty("type",
                    org.apache.commons.lang.StringUtils.defaultString(stakeHolderForm.getType()));
            jsonObject.addProperty("licenceNumber",
                    org.apache.commons.lang.StringUtils.defaultString(stakeHolderForm.getLicenceNumber()));
            jsonObject.addProperty("issueDate",
                    DateUtils.toDefaultDateFormat(stakeHolderForm.getIssueDate()));
