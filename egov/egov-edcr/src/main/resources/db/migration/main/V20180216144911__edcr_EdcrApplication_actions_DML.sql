...
Insert into eg_roleaction values((select id from eg_role where name='Super User'),(select id from eg_action where name='New-EdcrApplication'));
...
Insert into eg_roleaction values((select id from eg_role where name='Super User'),(select id from eg_action where name='Create-EdcrApplication'));
...
Insert into eg_roleaction values((select id from eg_role where name='Super User'),(select id from eg_action where name='Update-EdcrApplication'));
...
Insert into eg_roleaction values((select id from eg_role where name='Super User'),(select id from eg_action where name='View-EdcrApplication'));
...
Insert into eg_roleaction values((select id from eg_role where name='Super User'),(select id from eg_action where name='Edit-EdcrApplication'));
...
Insert into eg_roleaction values((select id from eg_role where name='Super User'),(select id from eg_action where name='Result-EdcrApplication'));
...
Insert into eg_roleaction values((select id from eg_role where name='Super User'),(select id from eg_action where name='Search and View Result-EdcrApplication'));
...
Insert into eg_roleaction values((select id from eg_role where name='Super User'),(select id from eg_action where name='Search and Edit Result-EdcrApplication'));
