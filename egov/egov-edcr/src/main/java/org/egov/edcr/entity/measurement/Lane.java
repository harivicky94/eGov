...
@Entity
@Table(name = "EDCR_LANE")
@SequenceGenerator(name = Lane.SEQ_EDCR_LANE, sequenceName = Lane.SEQ_EDCR_LANE, allocationSize = 1)
public class Lane extends Measurement{

    public static final String SEQ_EDCR_LANE = "SEQ_EDCR_LANE";
    private static final long serialVersionUID = 6171662500667567042L;
    ...
    private PlanDetail lanePlanDetail;
    ...
    public PlanDetail getLanePlanDetail() {
        return lanePlanDetail;
    }

    public void setLanePlanDetail(PlanDetail lanePlanDetail) {
        this.lanePlanDetail = lanePlanDetail;
    }
}