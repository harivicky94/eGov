...
@Entity
@Table(name = "EDCR_CULDESAC_ROAD")
@SequenceGenerator(name = CulDeSacRoad.SEQ_EDCR_CULDESAC_ROAD, sequenceName = CulDeSacRoad.SEQ_EDCR_CULDESAC_ROAD, allocationSize = 1)
public class CulDeSacRoad extends Measurement {

    public static final String SEQ_EDCR_CULDESAC_ROAD = "SEQ_EDCR_CULDESAC_ROAD";
    private static final long serialVersionUID = 4294656625151208606L;
    ...
    private PlanDetail culDeSacPlanDetail;
    ...
    public PlanDetail getCulDeSacPlanDetail() {
        return culDeSacPlanDetail;
    }

    public void setCulDeSacPlanDetail(PlanDetail culDeSacPlanDetail) {
        this.culDeSacPlanDetail = culDeSacPlanDetail;
    }
}
