...
@Entity
@Table(name = "EDCR_FLOORUNIT")
@SequenceGenerator(name = FloorUnit.SEQ_EDCR_FLOORUNIT, sequenceName = FloorUnit.SEQ_EDCR_FLOORUNIT, allocationSize = 1)
public class FloorUnit extends Measurement{
    ...
    public PlanDetail getFuPlanDetail() {
        return fuPlanDetail;
    }

    public void setFuPlanDetail(PlanDetail fuPlanDetail) {
        this.fuPlanDetail = fuPlanDetail;
    }
