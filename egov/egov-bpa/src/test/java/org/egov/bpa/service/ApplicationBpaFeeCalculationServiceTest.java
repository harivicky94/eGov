...
public class ApplicationBpaFeeCalculationServiceTest {
    ...
    public void testCalculateAreaForAdditionalFee_WithFeeAsZero() {
        ...
        applicationFloorDetails.add(getApplicationFloorDetail(buildingDetail, BigDecimal.valueOf(3000),
                BigDecimal.valueOf(1000), "07", "Mercantile / Commercial", Long.valueOf(2), Double.valueOf(65),
                Double.valueOf(2.5),
                Double.valueOf(4)));
        ...
        applicationFloorDetails.add(getApplicationFloorDetail(buildingDetail, BigDecimal.valueOf(2000),
                BigDecimal.valueOf(1000), "05", "Assembly", Long.valueOf(3), Double.valueOf(40), Double.valueOf(1.5),
                Double.valueOf(2.5)));
    ...
    @Test
    public void testCalculatePermissionFee_mixedOuccupancy() {
        ...
        applicationBpaFeeCalculationService.calculateFeeByServiceType(application, serviceTypeList, applicationFee);
        assertEquals(2, applicationFee.getApplicationFeeDetail().size());
        assertEquals(BigDecimal.valueOf(175000), applicationFee.getApplicationFeeDetail().get(0).getAmount());
        assertEquals(BigDecimal.valueOf(3223620), applicationFee.getApplicationFeeDetail().get(1).getAmount());

    }

    @Test
    public void testCalculatePermissionFee_mixedOuccupancy_Case1() {
