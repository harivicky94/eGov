...
<div class="panel-heading custom_form_panel_heading">
    <div class="panel-title">
        <spring:message code="title.edcrapplication.new" />
    </div>
</div>
<div class="panel-body">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label text-right">E-Dcr Upload</label>
        <div class="col-sm-4 add-margin">
            <div class="fileSection col-md77-4">
                <input type="file" name="dxfFile" id="myfile" style="display:none;">
